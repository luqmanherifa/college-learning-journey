                ...
                <div class="row">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_object($query)){
                                            ...
                                            echo '<a href="cart.php?id=101; ?> &action=add">';
                                    ...
                                    <div class="cart">
                                        <a href="cart.php?id=101 &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)){
                                            echo '<p class="product-price"> Rp. '.$row['Harga'].',-</p>';
                                            echo '<a href="cart.php?id=102; ?> &action=add">';
                                            echo '<h6>'.$row['Nama_Barang'].' ('.$row['Kategori'].')</h6>';
                                            echo '</a>';
                                        }
                                ...
                                <div class="ratings-cart text-right">
                                    <div class="cart">
                                        <a href="cart.php?id=102 &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)){
                                            echo '<p class="product-price"> Rp. '.$row['Harga'].',-</p>';
                                            echo '<a href="cart.php?id=103; ?> &action=add">';
                                            echo '<h6>'.$row['Nama_Barang'].' ('.$row['Kategori'].')</h6>';
                                            echo '</a>';
                                        }
                                    ?>
                                ...
                                <div class="ratings-cart text-right">
                                    <div class="cart">
                                        <a href="cart.php?id=103; &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/data-img/MAKANAN/royal canin 8.5gr (kucing) - 22.000.png" alt="">
                                <!-- Hover Thumb -->
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <?php 
                                    // Mengambil semua data dari "tbsiswa"
                                    $sql = 'SELECT * FROM data_toko WHERE ID_Barang=104';
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)){
                                            echo '<p class="product-price"> Rp. '.$row['Harga'].',-</p>';
                                            echo '<a href="cart.php?id=104; ?> &action=add">';
                                            echo '<h6>'.$row['Nama_Barang'].' ('.$row['Kategori'].')</h6>';
                                            echo '</a>';
                                        }
                                    ?>
                                ...
                                <div class="ratings-cart text-right">
                                    <div class="cart">
                                        <a href="cart.php?id=104; &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/data-img/MAKANAN/whiskas 85gr (kucing) - 6000.png" alt="">
                                <!-- Hover Thumb -->
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <?php 
                                    // Mengambil semua data dari "tbsiswa"
                                    $sql = 'SELECT * FROM data_toko WHERE ID_Barang=105';
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)){
                                            echo '<p class="product-price"> Rp. '.$row['Harga'].',-</p>';
                                            echo '<a href="cart.php?id=105; ?> &action=add">';
                                            echo '<h6>'.$row['Nama_Barang'].' ('.$row['Kategori'].')</h6>';
                                            echo '</a>';
                                        }
                                    ?>
                                ...
                                <div class="ratings-cart text-right">
                                    <div class="cart">
                                        <a href="cart.php?id=105; &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/data-img/MAKANAN/bloodworms 20gr (ikan) - 105.000.png" alt="">
                                <!-- Hover Thumb -->
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <?php 
                                    // Mengambil semua data dari "tbsiswa"
                                    $sql = 'SELECT * FROM data_toko WHERE ID_Barang=106';
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)){
                                            echo '<p class="product-price"> Rp. '.$row['Harga'].',-</p>';
                                            echo '<a href="cart.php?id=106; ?> &action=add">';
                                            echo '<h6>'.$row['Nama_Barang'].' ('.$row['Kategori'].')</h6>';
                                            echo '</a>';
                                        }
                                    ?>
                                ...
                                <div class="ratings-cart text-right">
                                    <div class="cart">
                                        <a href="cart.php?id=106; &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
