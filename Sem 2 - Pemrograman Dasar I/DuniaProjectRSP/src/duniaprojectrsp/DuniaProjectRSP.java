/*
 * To change this license header, pilihan License Headers in Project Properties.
 * To change this template file, pilihan Tools | Templates
 * and open the template in the editor.
 */
package duniaprojectrsp;
...
public class DuniaProjectRSP {
    ...
    static void transaksi() {
            ...
            System.out.println("     xx - 99 untuk Opsi lain");
            System.out.println("[01] "+jenis_keyboard[0]+"\t: Rp"+harga_keyboard[0]);
            System.out.println("[02] "+jenis_keyboard[1]+"\t: Rp"+harga_keyboard[1]);
            System.out.println("[03] "+jenis_keyboard[2]+"\t: Rp"+harga_keyboard[2]);
            System.out.println("[04] "+jenis_keyboard[3]+"\t: Rp"+harga_keyboard[3]);
            ...
            System.out.println("[xx] Input barang secara manual");
