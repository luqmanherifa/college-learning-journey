 ...
 */
package duniaprojectuas_update4;
 ...
 * @author Kyrin
 */
public class DuniaProjectUAS_Update4 {
    ...
    static int choose, inputjumlah, inputharga, inputbayar, rumustodi, rumusdiskon, rumustotal, rumuskembali;
    static int cekstok, tojumsnack, totaljumlahdiskon, tojumdrink;
    static int inputarray, inserthargas, insertstoks, inserthargad, insertstokd, a, b;
    ...
    static void update_snack() {
            ...
            stok_snack[inputarray-1] = input.nextInt();
    }
    ...
    static void update_drink() {
            ...
            System.out.print("Update Stok\t: ");
            stok_drink[inputarray-1] = input.nextInt();
    }
    ...
    static void update_admin() {
            ...
            System.out.print("ID Admin\t: ");
            kode_admin[inputarray-1] = input.next();
    }
    ...
    static void beli_drink() {
            ...
            System.out.println("==============================================");
            System.out.println("Harga\t\t: Rp"+tojumsnack+" ("+harga_drink[inputarray-1]+" x "+inputjumlah+") - "+tandadiskon);
