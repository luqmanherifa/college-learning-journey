                ...
                <div class="row">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_object($query)){
                                            ...
                                            echo '<a href="cart.php?id=201; ?> &action=add">';
                                    ...
                                    <div class="cart">
                                        <a href="cart.php?id=201 &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)){
                                            echo '<p class="product-price"> Rp. '.$row['Harga'].',-</p>';
                                            echo '<a href="cart.php?id=202; ?> &action=add">';
                                            echo '<h6>'.$row['Nama_Barang'].' ('.$row['Kategori'].')</h6>';
                                            echo '</a>';
                                        }
                                ...
                                <div class="ratings-cart text-right">
                                    <div class="cart">
                                        <a href="cart.php?id=202 &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)){
                                            echo '<p class="product-price"> Rp. '.$row['Harga'].',-</p>';
                                            echo '<a href="cart.php?id=203; ?> &action=add">';
                                            echo '<h6>'.$row['Nama_Barang'].' ('.$row['Kategori'].')</h6>';
                                            echo '</a>';
                                        }
                                    ?>
                                ...
                                <div class="ratings-cart text-right">
                                    <div class="cart">
                                        <a href="cart.php?id=203; &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/data-img/OBAT/obat diare kucing - 27.000.png" alt="">
                                <!-- Hover Thumb -->
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <?php 
                                    // Mengambil semua data dari "tbsiswa"
                                    $sql = 'SELECT * FROM data_toko WHERE ID_Barang=204';
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)){
                                            echo '<p class="product-price"> Rp. '.$row['Harga'].',-</p>';
                                            echo '<a href="cart.php?id=204; ?> &action=add">';
                                            echo '<h6>'.$row['Nama_Barang'].' ('.$row['Kategori'].')</h6>';
                                            echo '</a>';
                                        }
                                    ?>
                                ...
                                <div class="ratings-cart text-right">
                                    <div class="cart">
                                        <a href="cart.php?id=204; &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/data-img/OBAT/obat bulu kucing - 25.000.png" alt="">
                                <!-- Hover Thumb -->
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <?php 
                                    // Mengambil semua data dari "tbsiswa"
                                    $sql = 'SELECT * FROM data_toko WHERE ID_Barang=205';
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)){
                                            echo '<p class="product-price"> Rp. '.$row['Harga'].',-</p>';
                                            echo '<a href="cart.php?id=205; ?> &action=add">';
                                            echo '<h6>'.$row['Nama_Barang'].' ('.$row['Kategori'].')</h6>';
                                            echo '</a>';
                                        }
                                    ?>
                                ...
                                <div class="ratings-cart text-right">
                                    <div class="cart">
                                        <a href="cart.php?id=205; &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="img/data-img/OBAT/obat antibakteri ikan - 90.000.png" alt="">
                                <!-- Hover Thumb -->
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <?php 
                                    // Mengambil semua data dari "tbsiswa"
                                    $sql = 'SELECT * FROM data_toko WHERE ID_Barang=206';
                                    $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)){
                                            echo '<p class="product-price"> Rp. '.$row['Harga'].',-</p>';
                                            echo '<a href=a href="cart.php?id=206; ?> &action=add">';
                                            echo '<h6>'.$row['Nama_Barang'].' ('.$row['Kategori'].')</h6>';
                                            echo '</a>';
                                        }
                                    ?>
                                ...
                                <div class="ratings-cart text-right">
                                    <div class="cart">
                                        <a href="cart.php?id=206; &action=add" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
