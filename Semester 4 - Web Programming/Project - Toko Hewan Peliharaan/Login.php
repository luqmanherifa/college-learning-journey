...
<head>
    ...
    <!-- Title  -->
    <title>LUQFE - PET SHOP | LOGIN</title>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="Login(Logika).php" method="post">
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        <input name="email" type="email" class="form-control" id="email" placeholder="Email" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input name="pass" type="password" class="form-control" id="password" value="" placeholder="Password" required>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <div class="amado-btn-group mt-30 mb-100">
                                            <button class="btn amado-btn mb-15" type="submit" name="submit" value="proses"> LOGIN </button>
                                        </div>
                                    </div>
                                </div>
                            </form>
